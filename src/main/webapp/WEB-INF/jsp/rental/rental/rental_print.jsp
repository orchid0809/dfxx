...
<div >
    <div id="PrintHTML" style="opacity:0.3;-moz-opacity: 0.3; border:0px solid black;height:100%;width:100%;">
        ...
        <div style="border:0px solid red;font-size: 110px;width:100%;margin-top:30px; text-align: center;height: 5%; display: table;
        ">
      ...
      <%-- <div class="panel panel-default">
        ...
        <div style="border:0px solid black;margin-bottom:0px;">
            <table style="width: 100%;">
                <tr>
                    <td style="width: 25%;line-height:50px; font-size: 90px; text-align: center; border: 0px solid black;" >
                        ${pd.CONTACT_PHONE}
                    </td>
                </tr>
            </table>
