										...
										<div class="form-group">
											...
											<div class="col-sm-9">
												<label style="float:left;padding-left: 8px;padding-top:7px;">
													<input name="TYPE" class="ace" id="form-field-radio1" type="radio" VALUE="0" <c:if test="${pd.TYPE==0 or pd.TYPE==null}">checked</c:if> >	<span class="lbl">出租</span>

												</label>
												<label style="float:left;padding-left: 5px;padding-top:7px;">
													<input name="TYPE" class="ace" id="form-field-radio2" type="radio" VALUE="1" <c:if test="${pd.TYPE==1}">checked</c:if>>	<span class="lbl">出售</span>
...
<script src="static/ace/js/ace/ace.js"></script>
		...
		function addDateTime(date){
			...
			var s=d.getSeconds();
			d=new Date(year,month+1,day,hour,min,s);
